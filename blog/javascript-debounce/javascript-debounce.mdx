---
title: "Debounce in JavaScript: Limitting the rate of the function call"
description: "Debounce is a pattern to limit the rate at which a function can fire. it's also one of the most frequently asked JavaScript Interview questions as required a deep understanding of JavaScript asynchronous programming and closer. "
date: "2022-05-14"
...
**Debounce** is a pattern to limit the rate at which a function can fire. it's also one of the most frequently asked JavaScript Interview questions as required a deep understanding of JavaScript asynchronous programming and closer.
...
1. Providing suggestions too early, maybe at every keypress, would be meaningless. Also, it will put an unnecessary load on the server.
 ...
 * [x] Cancelling a function call, if new call happen before the wait expired.
 ...
 * Agenda:
 * [x] Delaying a function call
 * [x] Cancelling a function call, if new call happen before the wait.
 * [x] Maintaining the Context.
 */
